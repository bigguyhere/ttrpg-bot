    ...
    export function setup(commands: GuildApplicationCommandManager |
        ...
        commands?.create({
            ...
            options: [
                ...
                {
                    name: 'view',
                    description: 'View summary of all tbs in current game or skills for a specific character.',
                    type: ApplicationCommandOptionType.Subcommand,
                    options:[
                        {
                            name: 'tb-name',
                            description: 'Name of tb to be viewed. Mutually exclusive with \'char-name\' option.',
                            required: false,
                            type: ApplicationCommandOptionType.String
                        },
                        {
